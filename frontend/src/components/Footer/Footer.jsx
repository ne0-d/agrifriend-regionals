                ...
                <MDBContainer className="mt-5 mb-4 text-center text-md-left">
                    <MDBRow className="mt-3">
                        ...
                        <MDBCol md="3" lg="3" xl="4" className="mb-4 dark-grey-text">
                            ...
                            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{ width: "60px" }} />
                            <p><i className="fa fa-home mr-3" /> Raipur, Chhattisgarh, India</p>
                            <p><i className="fa fa-envelope mr-3" /> nithin20102@iiitnr.edu.in</p>
                            <p><i className="fa fa-envelope mr-3" /> dhruv20102@iiitnr.edu.in</p>
                            <p><i className="fa fa-envelope mr-3" /> aman20102@iiitnr.edu.in</p>
                            <p><i className="fa fa-envelope mr-3" /> himanshu20102@iiitnr.edu.in</p>
                            {/* <p><i className="fa fa-phone mr-3" /> </p> */}
